...
class TestRouterContract(unittest.TestCase):
    ...
    def test_built_payloads_value_without_crashing(self):
        ...
        # GMX.TO likewise removed 2026-09-19 (exited for capital efficiency in favour of
        # satellite plays; see SPEAR_STATUS.md) — same rule, it no longer resolves.
        built = self.mapper.build_all(["AGA.V", "GROY"], merged)
